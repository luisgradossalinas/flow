...
var SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_media_prefix) {
        ...
        quickElement('img', filter_p, '', 'src', admin_media_prefix + 'zendr/css/graphics/selector-search.gif');
        ...
        quickElement('img', selector_filter, '', 'src', admin_media_prefix + (is_stacked ? 'zendr/css/graphics/selector_stacked-add.gif':'zendr/css/graphics/selector-add.gif'), 'alt', 'Add');
