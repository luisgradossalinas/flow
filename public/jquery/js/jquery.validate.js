...
$.extend($.validator, {
	...
	messages: {
        ...
        maxlength: $.format("Porfavor ingresa menos de {0} caractéres."),
        minlength: $.format("Porfavor ingresa almenos {0} caractéres."),
        rangelength: $.format("Porfavor ingresa un valor entre {0} y {1} caractéres de longitud."),
        range: $.format("Ingresa un valor entre {0} y {1}."),
        max: $.format("Ingresa un valor menor o igual que {0}."),
