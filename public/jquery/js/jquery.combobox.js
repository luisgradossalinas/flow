...
jQuery.fn.combobox = function(options)
{
	...
	return this.each(
		function()
		{
			...
			var _dropDownButtonDefaultStyle = "overflow:hidden;width: 20px;height: 18px;color:#000;background: #D6D3CE;,font-family: verdana;font-size: 10px;cursor: default;text-align: center;vertical-align:middle;";
