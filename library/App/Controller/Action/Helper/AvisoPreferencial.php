    ...
    extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function _insertarNuevoAvisoImpreso(
        array $dataPost,
        App_Form_Manager $managerEstudio, 
        App_Form_Manager $managerExperiencia, 
        App_Form_Manager $managerIdioma, 
        App_Form_Manager $managerPrograma, 
        App_Form_Manager $managerPregunta,
        $idEmpresa = null,
        $extiende = null,
        $republica = null
    )
    {
        ...
        $this->_anuncioWebId = $avisoHelper->_insertarNuevoPuesto($dataPost, $extiende, $idEmpresa, $republica);
    ...
    )
    {
        ...
        $this->_anuncioWebId = $avisoHelper->_insertarNuevoPuesto($dataPost, $idEmpresa);
        $avisoHelper->_insertarPreguntas($managerPregunta, $idEmpresa);
        $avisoHelper->_insertarEstudios($managerEstudio);
        $avisoHelper->_insertarExperiencia($managerExperiencia);
        $avisoHelper->_insertarIdiomas($managerIdioma);
    ...
    public function getGrillaByProducto($productoId)
    {
        ...
        $arrayProducto =
            $modelProducto->getTarifasAvisoPreferencial($productoId, $usoMembresia != 0 ? $this->_idMembresia : null);
