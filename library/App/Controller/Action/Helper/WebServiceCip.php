...
class App_Controller_Action_Helper_WebServiceCip 
    ...
    private function generarXmlEncriptado($rowAnuncio)
    {
        ...
        $sxe->addChild(
            "UrlOk", htmlspecialchars(
                $this->_config->app->siteUrl."/empresa/comprar-aviso/ok-pago-efectivo"
            )
        );
        $sxe->addChild(
            "UrlError", htmlspecialchars(
                $this->_config->app->siteUrl."/empresa/publica-aviso/paso4/aviso/".
